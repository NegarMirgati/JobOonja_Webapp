...
class RegisterForm extends Component<any, State>{
    ...
    handleSubmit = (event : any) => {
        ...
        if(password.length < 6){
            ...
            hasError = true
            console.log("ssd;klk;k;;ll;kllkkl;;k;kkl;")
        }
        ...
        if(hasError == false){
            var link = 'http://localhost:8080/jobKhar_war/user?id=' + this.state.username + '&firstName=' + this.state.name + '&lastName=' + this.state.lastname +
    ...
    render(){
        return(
            <div>
                <ToastContainer /> {/* Keep only one instance here */}
                    ...
                    <div className = "row">
                        <div className = "col-sm-12">
                            ...
                            <form className = "register-form" onSubmit={this.handleSubmit}>
                                    ...
                                    <button onClick = {this.handleSubmit } type = "submit" className = "add-skill-button" > ثبت نام </button>
                                </form>
